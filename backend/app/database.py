...
async def init_db():
    ...
    if is_postgres:
        pg_migration_statements = [
            ...
            "ALTER TABLE assessments ADD COLUMN IF NOT EXISTS slot_open BOOLEAN DEFAULT TRUE;",
            "ALTER TABLE assessments ADD COLUMN IF NOT EXISTS active_slot_name VARCHAR(100) DEFAULT 'Slot 1';",
        ...
        sqlite_migration_statements = [
            ...
            "ALTER TABLE assessments ADD COLUMN slot_open BOOLEAN DEFAULT 1;",
            "ALTER TABLE assessments ADD COLUMN active_slot_name VARCHAR(100) DEFAULT 'Slot 1';",
